...
- Want to see if high vs low treatment has an effect on weight gain.

- Need to account for breed, and initial weight.

- Weight gain is increase in weight as age increases. How does the slope change
with treatment?

- Slope can probably also differ by breed as well.

- Need interactions for Age and Treatment and Age and Breed.
