...
3. We'll add a special 'metadata' block to the top of the script that allows you to set the title and author. Copy and paste the following code block, then change the author as appropriate. More information on formatting up R notebooks (e.g. headings, subheadings, bullet points, emphasis etc.) can be found in the summary sheet on stream.
