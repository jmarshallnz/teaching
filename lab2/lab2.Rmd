...
7. Try removing `Height` and adding `Sex` into your model. Recall that it didn't look as if there was an effect of sex when we did the boxplot last week. What is your conclusion now? Why would this be?
