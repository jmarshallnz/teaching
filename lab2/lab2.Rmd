...
7. Finally, take a look at the model diagnostics for the model with all covariates. *Add some notes to your R script as to whether the model assumptions are satisfied*.

8. Re-build your Word document and make sure it includes everything you want it to. You'll be wanting to refer back to it later.
