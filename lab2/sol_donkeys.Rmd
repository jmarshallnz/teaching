...
What about `Sex`? Recall that `Sex` wasn't important when we looked at the overall plots of weight vs sex last time (there was little difere)

asn't important when we looked at the plots last time (there was little difference in the weight between male and femal eReplacing `Height` and replacing it with `Sex` gives:
