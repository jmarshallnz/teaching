...
## Summary output for multiple covariates {.smaller}
...
- Heart girth, umbilical girth and length are all significant after accounting for other covariates.
...
- The F-test suggests the average right wing length differs between areas.
