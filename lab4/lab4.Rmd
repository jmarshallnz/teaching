...
6. Does this plot agree with your anova results?

7. Repeat the above, this time adding an interaction term between `Feed` and `Rank`. Is there evidence of a differential effect of feed between twins and singles?
...
where $\epsilon$ is the $j$-th residual of person $i$ from the linear model with just farm in it, $\mathsf{person}_i$ is the average residual for person $i$, and $\eta_{ij}$ is the left-over $j$-th after subtracting out the person level average.
...
5. All the best for the rest of the course!